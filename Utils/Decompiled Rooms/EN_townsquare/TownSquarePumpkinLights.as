package
{
   ...
   public class TownSquarePumpkinLights extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function TownSquarePumpkinLights()
      {
         super();
         trace("TownSquarePumpkinLights Constructor");
