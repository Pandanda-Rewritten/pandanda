package
{
   ...
   public class TownSquarePumpkinCluster1 extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function TownSquarePumpkinCluster1()
      {
         super();
         trace("TownSquarePumpkinCluster1 Constructor");
