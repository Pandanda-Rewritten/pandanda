package
{
   ...
   public class TownSquarePumpkinCluster2 extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function TownSquarePumpkinCluster2()
      {
         super();
         trace("TownSquarePumpkinCluster2 Constructor");
