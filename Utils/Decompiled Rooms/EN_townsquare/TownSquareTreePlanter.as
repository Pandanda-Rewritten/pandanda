package
{
   ...
   public class TownSquareTreePlanter extends Sprite implements IInteractiveObject
   {
      ...
      public function TownSquareTreePlanter()
      {
         super();
         trace("TownSquareTreePlanter Constructor");
