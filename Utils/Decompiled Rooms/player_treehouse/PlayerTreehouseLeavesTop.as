package
{
   ...
   public class PlayerTreehouseLeavesTop extends Sprite implements IInteractiveObject
   {
      ...
      public function PlayerTreehouseLeavesTop()
      {
         super();
         trace("PlayerTreehouseLeavesTop Constructor");
