package
{
   ...
   public class FurnitureItems
   {
      ...
      public function getFurnitureItem(param1:String) : IFurnitureItem
      {
         ...
         try
         {
            return m_furniturePack1Doc.getFurnitureItem(itemId) as IFurnitureItem;
         }
         catch(e:Error)
         {
      ...
      public function getBackpackSprite(param1:String) : Sprite
      {
         ...
         try
         {
            return Sprite(m_furniturePack1Doc.getBackpackSprite(itemId));
         }
         catch(e:Error)
         {
