package
{
   ...
   public class PlayerTreehouseTreeLeft extends Sprite implements IInteractiveObject
   {
      ...
      public function PlayerTreehouseTreeLeft()
      {
         super();
         trace("PlayerTreehouseTreeLeft Constructor");
