package
{
   ...
   public class PlayerTreehouseLeavesLeft extends Sprite implements IInteractiveObject
   {
      ...
      public function PlayerTreehouseLeavesLeft()
      {
         super();
         trace("PlayerTreehouseLeavesLeft Constructor");
