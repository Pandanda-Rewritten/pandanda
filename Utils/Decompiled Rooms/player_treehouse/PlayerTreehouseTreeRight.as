package
{
   ...
   public class PlayerTreehouseTreeRight extends Sprite implements IInteractiveObject
   {
      ...
      public function PlayerTreehouseTreeRight()
      {
         super();
         trace("PlayerTreehouseTreeRight Constructor");
