package
{
   ...
   public class GraveyardDateHeadstone extends Sprite implements IInteractiveObject
   {
      ...
      public function GraveyardDateHeadstone()
      {
         super();
         trace("GraveyardDateHeadstone Constructor");
