package
{
   ...
   public class GraveyardRIPheadstone extends Sprite implements IInteractiveObject
   {
      ...
      public function GraveyardRIPheadstone()
      {
         super();
         trace("GraveyardRIPheadstone Constructor");
