package
{
   ...
   public class GraveyardFluffyHeadstone extends Sprite implements IInteractiveObject
   {
      ...
      public function GraveyardFluffyHeadstone()
      {
         super();
         trace("GraveyardFluffyHeadstone Constructor");
