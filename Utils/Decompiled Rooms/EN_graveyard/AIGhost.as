package
{
   ...
   public class AIGhost extends Avatar
   {
      ...
      public function AIGhost(param1:int, param2:int, param3:int)
      {
         super(AvatarModels.AVATAR_MODEL_GHOST1);
      ...
      {
         getModel().setPulse(param1,976419);
      }
      ...
      {
         return InteractiveObjectType.IOBJECT_GHOST;
      }
