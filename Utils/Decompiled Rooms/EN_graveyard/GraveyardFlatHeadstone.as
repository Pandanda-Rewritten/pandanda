package
{
   ...
   public class GraveyardFlatHeadstone extends Sprite implements IInteractiveObject
   {
      ...
      public function GraveyardFlatHeadstone()
      {
         super();
         trace("GraveyardFlatHeadstone Constructor");
