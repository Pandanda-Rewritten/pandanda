package
{
   ...
   public class GraveyardRightRailing extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function GraveyardRightRailing()
      {
         super();
         trace("GraveyardRightRailing Constructor");
      ...
      public function setNightMask(param1:Number) : void
      {
         ...
         if(param1 > 0)
         {
            _loc2_ = param1 * GraveyardScene.NIGHT_MASK_SCENE_ALPHA * SceneRoot.DEFAULT_NIGHT_MASK_INTENSITY;
