package
{
   ...
   public class GraveyardLeftRailing extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function GraveyardLeftRailing()
      {
         super();
         trace("GraveyardLeftRailing Constructor");
