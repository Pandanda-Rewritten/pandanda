package
{
   ...
   public class StonehengeRockFlowers extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function StonehengeRockFlowers()
      {
         super();
         trace("StonehengeRockFlowers Constructor");
