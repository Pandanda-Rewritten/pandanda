package
{
   ...
   public class StonehengeRockRightBorder extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function StonehengeRockRightBorder()
      {
         super();
         trace("StonehengeRockRightBorder Constructor");
      ...
      public function setNightMask(param1:Number) : void
      {
         ...
         if(param1 > 0)
         {
            _loc2_ = param1 * StonehengeScene.NIGHT_MASK_SCENE_ALPHA * SceneRoot.DEFAULT_NIGHT_MASK_INTENSITY;
