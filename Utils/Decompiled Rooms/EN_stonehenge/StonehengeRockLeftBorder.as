package
{
   ...
   public class StonehengeRockLeftBorder extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function StonehengeRockLeftBorder()
      {
         super();
         trace("StonehengeRockLeftBorder Constructor");
