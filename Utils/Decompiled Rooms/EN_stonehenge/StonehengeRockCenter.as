package
{
   ...
   public class StonehengeRockCenter extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function StonehengeRockCenter()
      {
         super();
         trace("StonehengeRockCenter Constructor");
