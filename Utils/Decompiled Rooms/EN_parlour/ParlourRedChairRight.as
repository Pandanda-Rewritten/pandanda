package
{
   ...
   public class ParlourRedChairRight extends Sprite implements IInteractiveObject
   {
      ...
      public function ParlourRedChairRight()
      {
         super();
         trace("ParlourRedChairRight Constructor");
