package
{
   ...
   public class ParlourBlueChairRight extends Sprite implements IInteractiveObject
   {
      ...
      public function ParlourBlueChairRight()
      {
         super();
         trace("ParlourBlueChairRight Constructor");
