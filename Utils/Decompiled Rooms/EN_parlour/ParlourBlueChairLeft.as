package
{
   ...
   public class ParlourBlueChairLeft extends Sprite implements IInteractiveObject
   {
      ...
      public function ParlourBlueChairLeft()
      {
         super();
         trace("ParlourBlueChairLeft Constructor");
