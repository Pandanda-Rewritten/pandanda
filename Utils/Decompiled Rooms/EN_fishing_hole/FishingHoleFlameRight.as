package
{
   ...
   public class FishingHoleFlameRight extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function FishingHoleFlameRight()
      {
         super();
         trace("FishingHoleFlameRight Constructor");
