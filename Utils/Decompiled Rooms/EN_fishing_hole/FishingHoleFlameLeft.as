package
{
   ...
   public class FishingHoleFlameLeft extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function FishingHoleFlameLeft()
      {
         super();
         trace("FishingHoleFlameLeft Constructor");
