package
{
   ...
   public class ClothesStoreRightShelves extends Sprite implements IInteractiveObject
   {
      ...
      public function ClothesStoreRightShelves()
      {
         super();
         trace("ClothesStoreRightShelves Constructor");
