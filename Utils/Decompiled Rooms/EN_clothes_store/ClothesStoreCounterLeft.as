package
{
   ...
   public class ClothesStoreCounterLeft extends Sprite implements IInteractiveObject
   {
      ...
      public function ClothesStoreCounterLeft()
      {
         super();
         trace("ClothesStoreCounterLeft Constructor");
