package
{
   ...
   public class ClothesStoreBackRightShelves extends Sprite implements IInteractiveObject
   {
      ...
      public function ClothesStoreBackRightShelves()
      {
         super();
         trace("ClothesStoreBackRightShelves Constructor");
