package
{
   ...
   public class ClothesStoreBackLeftShelves extends Sprite implements IInteractiveObject
   {
      ...
      public function ClothesStoreBackLeftShelves()
      {
         super();
         trace("ClothesStoreBackLeftShelves Constructor");
