package
{
   ...
   public class TownSquare2Sawhorse2 extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function TownSquare2Sawhorse2()
      {
         super();
         trace("TownSquare2Sawhorse2 Constructor");
      ...
      public function setNightMask(param1:Number) : void
      {
         ...
         if(param1 > 0)
         {
            _loc2_ = param1 * TownSquare2Scene.NIGHT_MASK_SCENE_ALPHA * SceneRoot.DEFAULT_NIGHT_MASK_INTENSITY;
