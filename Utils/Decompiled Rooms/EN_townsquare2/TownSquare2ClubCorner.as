package
{
   ...
   public class TownSquare2ClubCorner extends Sprite implements IInteractiveObject
   {
      ...
      public function TownSquare2ClubCorner()
      {
         super();
         trace("TownSquare2ClubCorner Constructor");
      ...
      public function setNightMask(param1:Number) : void
      {
         if(param1 != 0)
         {
            ...
            this.s_nightMask.alpha = param1 * TownSquare2Scene.NIGHT_MASK_SCENE_ALPHA * SceneRoot.DEFAULT_NIGHT_MASK_INTENSITY;
         }
         else
         {
