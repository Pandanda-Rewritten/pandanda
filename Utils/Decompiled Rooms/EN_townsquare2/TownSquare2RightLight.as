package
{
   ...
   public class TownSquare2RightLight extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function TownSquare2RightLight()
      {
         super();
         trace("TownSquare2RightLight Constructor");
