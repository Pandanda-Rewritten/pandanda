package
{
   ...
   public class TownSquare2LeftLight extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function TownSquare2LeftLight()
      {
         super();
         trace("TownSquare2LeftLight Constructor");
