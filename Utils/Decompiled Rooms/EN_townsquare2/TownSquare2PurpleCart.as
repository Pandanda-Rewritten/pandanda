package
{
   ...
   public class TownSquare2PurpleCart extends Sprite implements IInteractiveObject
   {
      ...
      public function TownSquare2PurpleCart()
      {
         super();
         trace("TownSquare2PurpleCart Constructor");
