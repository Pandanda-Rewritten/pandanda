package
{
   ...
   public class TownSquare2PumpkinLights extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function TownSquare2PumpkinLights()
      {
         super();
         trace("TownSquare2PumpkinLights Constructor");
