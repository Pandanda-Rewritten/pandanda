package
{
   ...
   public class TownSquare2PumpkinCluster extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function TownSquare2PumpkinCluster()
      {
         super();
         trace("TownSquare2PumpkinCluster Constructor");
