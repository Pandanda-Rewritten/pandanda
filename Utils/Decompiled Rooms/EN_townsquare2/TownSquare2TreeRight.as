package
{
   ...
   public class TownSquare2TreeRight extends Sprite implements IInteractiveObject
   {
      ...
      public function TownSquare2TreeRight()
      {
         super();
         trace("TownSquare2TreeRight Constructor");
