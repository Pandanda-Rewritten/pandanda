package
{
   ...
   public class TownSquare2Jackolantern extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function TownSquare2Jackolantern()
      {
         super();
         trace("TownSquare2Jackolantern Constructor");
