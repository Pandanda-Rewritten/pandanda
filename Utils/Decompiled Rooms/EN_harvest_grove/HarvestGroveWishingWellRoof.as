package
{
   ...
   public class HarvestGroveWishingWellRoof extends Sprite implements IInteractiveObject
   {
      ...
      public function HarvestGroveWishingWellRoof()
      {
         super();
         trace("HarvestGroveWishingWellRoof Constructor");
