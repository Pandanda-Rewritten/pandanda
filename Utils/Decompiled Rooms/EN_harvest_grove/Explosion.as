package
{
   ...
   public class Explosion extends Sprite
   {
      ...
      internal function enterFrameHandler(param1:Event) : void
      {
         ...
         var _loc3_:* = null;
         _loc2_ = 0;
         while(_loc2_ < this.m_particlesArray.length)
         {
            _loc3_ = this.m_particlesArray[_loc2_];
            _loc3_.y += _loc3_.speedY;
            _loc3_.x += _loc3_.speedX;
            _loc3_.rotation = this.randRange(0,360);
            _loc3_.scaleX = _loc3_.scaleY = this.randRange(0.2,1);
            _loc3_.alpha -= 0.02;
            _loc2_++;
         }
