package
{
   ...
   public class HarvestGroveWishingWellBase extends Sprite implements IInteractiveObject
   {
      ...
      public function HarvestGroveWishingWellBase()
      {
         super();
         trace("HarvestGroveWishingWellBase Constructor");
      ...
      public function setNightMask(param1:Number) : void
      {
         if(param1 != 0)
         {
            ...
            this.s_nightMask.alpha = param1 * HarvestGroveScene.NIGHT_MASK_SCENE_ALPHA * SceneRoot.DEFAULT_NIGHT_MASK_INTENSITY;
         }
         else
         {
