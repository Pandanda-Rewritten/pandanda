package
{
   ...
   public class HarvestGroveTreeFront extends Sprite implements IInteractiveObject
   {
      ...
      public function HarvestGroveTreeFront()
      {
         super();
         trace("HarvestGroveTreeFront Constructor");
