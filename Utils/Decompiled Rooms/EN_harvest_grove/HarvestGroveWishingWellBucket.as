package
{
   ...
   public class HarvestGroveWishingWellBucket extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function HarvestGroveWishingWellBucket()
      {
         super();
         trace("HarvestGroveWishingWellBucket Constructor");
      ...
      public function setNightMask(param1:Number) : void
      {
         ...
         if(param1 > 0)
         {
            _loc2_ = param1 * HarvestGroveScene.NIGHT_MASK_SCENE_ALPHA;
