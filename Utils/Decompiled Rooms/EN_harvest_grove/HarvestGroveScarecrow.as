package
{
   ...
   public class HarvestGroveScarecrow extends Sprite implements IInteractiveObject
   {
      ...
      public function HarvestGroveScarecrow()
      {
         super();
         trace("HarvestGroveScarecrow Constructor");
