package
{
   ...
   public class HarvestGroveTreeBack extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function HarvestGroveTreeBack()
      {
         super();
         trace("HarvestGroveTreeBack Constructor");
