package
{
   ...
   public class HarvestGrovePumpkins extends Sprite implements IInteractiveObject
   {
      ...
      public function HarvestGrovePumpkins()
      {
         super();
         trace("HarvestGrovePumpkins Constructor");
