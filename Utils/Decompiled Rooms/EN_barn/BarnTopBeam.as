package
{
   ...
   public class BarnTopBeam extends Sprite implements IInteractiveObject
   {
      ...
      public function BarnTopBeam()
      {
         super();
         trace("BarnTopBeam Constructor");
      ...
      public function setNightMask(param1:Number) : void
      {
         if(param1 != 0)
         {
            ...
            s_nightMask.alpha = param1 * BarnScene.NIGHT_MASK_SCENE_ALPHA * SceneRoot.DEFAULT_NIGHT_MASK_INTENSITY;
         }
         else
         {
