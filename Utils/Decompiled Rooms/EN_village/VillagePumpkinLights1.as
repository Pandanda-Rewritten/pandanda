package
{
   ...
   public class VillagePumpkinLights1 extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function VillagePumpkinLights1()
      {
         super();
         trace("VillagePumpkinLights1 Constructor");
