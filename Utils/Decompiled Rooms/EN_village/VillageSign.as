package
{
   ...
   public class VillageSign extends Sprite implements IInteractiveObject
   {
      ...
      public function VillageSign()
      {
         super();
         trace("VillageSign Constructor");
      ...
      public function setNightMask(param1:Number) : void
      {
         ...
         else
         {
            ...
            this.s_nightMask.alpha = param1 * VillageScene.NIGHT_MASK_SCENE_ALPHA;
         }
      }
   }
}
