package
{
   ...
   public class BunnyFieldFrontFlowers extends Sprite implements IInteractiveObject
   {
      ...
      public function BunnyFieldFrontFlowers()
      {
         super();
         trace("BunnyFieldFrontFlowers Constructor");
      ...
      public function setNightMask(param1:Number) : void
      {
         if(param1 != 0)
         {
            ...
            this.s_nightMask.alpha = param1 * BunnyFieldScene.NIGHT_MASK_SCENE_ALPHA * SceneRoot.DEFAULT_NIGHT_MASK_INTENSITY;
         }
         else
         {
