package
{
   ...
   public class UINavigationBar extends Sprite
   {
      ...
      {
         super();
         this.s_left.s_leftArrow.addEventListener(MouseEvent.CLICK,this.mouseClickListener,false,0,true);
         this.s_right.s_rightArrow.addEventListener(MouseEvent.CLICK,this.mouseClickListener,false,0,true);
      }
      
      public function setRightButtonVisible(param1:Boolean) : void
      {
         this.s_right.s_rightArrow.visible = param1;
      }
      ...
      public function setText(param1:String, param2:Boolean = false, param3:int = 18) : void
      {
         ...
         this.s_title.text = param1;
         this.s_title.setTextFormat(_loc4_);
      }
      
      internal function mouseClickListener(param1:MouseEvent) : void
      {
         if(param1.currentTarget != this.s_left.s_leftArrow)
         {
            if(param1.currentTarget == this.s_right.s_rightArrow)
            {
      ...
      {
         this.s_left.s_leftArrow.visible = param1;
      }
      
      public function destroy() : void
      {
         this.s_left.s_leftArrow.removeEventListener(MouseEvent.CLICK,this.mouseClickListener);
         this.s_right.s_rightArrow.removeEventListener(MouseEvent.CLICK,this.mouseClickListener);
      }
   }
}
