package
{
   ...
   public class BunnyFieldBackFlowers extends Sprite implements IInteractiveObject
   {
      ...
      public function BunnyFieldBackFlowers()
      {
         super();
         trace("BunnyFieldBackFlowers Constructor");
