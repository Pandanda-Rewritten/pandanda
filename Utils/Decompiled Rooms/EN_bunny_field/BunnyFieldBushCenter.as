package
{
   ...
   public class BunnyFieldBushCenter extends Sprite implements IInteractiveObject
   {
      ...
      public function BunnyFieldBushCenter()
      {
         super();
         trace("BunnyFieldBushCenter Constructor");
