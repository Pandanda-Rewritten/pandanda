package
{
   ...
   public class BunnyFieldGrassRight extends Sprite implements IInteractiveObject
   {
      ...
      public function BunnyFieldGrassRight()
      {
         super();
         trace("BunnyFieldGrassRight Constructor");
