package
{
   ...
   public class IslandWater extends Sprite implements IInteractiveObject
   {
      
      internal static const FOUNTAIN_MAX_ALPHA:Number = 0.15;
      ...
      public function IslandWater()
      {
         super();
         trace("IslantWater Constructor");
         m_yDepth = 0;
         cacheAsBitmap = true;
