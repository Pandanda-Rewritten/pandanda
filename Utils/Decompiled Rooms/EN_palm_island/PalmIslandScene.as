package
{
   ...
   public class PalmIslandScene extends SceneRoot implements IScene
   {
      ...
      internal var m_surfboard:IslandSurfboard;
      
      internal var m_water:IslandWater;
      
      internal var m_effectsContainerNightMaskTop:IslandSceneNightMask;
      
      public function PalmIslandScene()
      {
         var _loc2_:* = null;
         super();
         trace("PalmIslandScene Constructor");
         ...
         m_surfboard = new IslandSurfboard();
         m_surfboard.x = 801;
         m_surfboard.y = 219;
         m_surfboard.width = 98;
         m_surfboard.height = 217;
         m_surfboard.setYDepth(306);
         ...
         m_sceneObjects.push(m_surfboard);
