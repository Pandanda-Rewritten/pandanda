package
{
   ...
   public class VillagePumpkinsRight extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function VillagePumpkinsRight()
      {
         super();
         trace("VillagePumpkinsRight Constructor");
