package
{
   ...
   public class VillagePumpkinLights extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function VillagePumpkinLights()
      {
         super();
         trace("VillagePumpkinLights Constructor");
