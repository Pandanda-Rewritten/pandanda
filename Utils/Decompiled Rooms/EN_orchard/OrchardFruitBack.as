package
{
   ...
   public class OrchardFruitBack extends Sprite implements IInteractiveObject
   {
      
      public var m_yDepth:int;
      
      public function OrchardFruitBack()
      {
         super();
         trace("OrchardFruitBack Constructor");
      ...
      public function setNightMask(param1:Number) : void
      {
         ...
         if(param1 > 0)
         {
            _loc2_ = param1 * OrchardScene.NIGHT_MASK_SCENE_ALPHA;
