package
{
   public class GameClock
   {
      ...
      private static var m_instance:GameClock;
      
      private static const TRANSITION_SPEED:uint = 360;
      
      private static const NIGHT_START_HOUR:int = 19;
      
      private static const NIGHT_START_MINUTE:int = 5;
      
      private static const DAY_START_HOUR:int = 7;
      
      private static const DAY_START_MINUTE:int = 5;
      
      private static const PANDANDA_GMT_OFFSET:int = 7;
      
      private static const CLOCK_TIMER:int = 10000;
      
      private static var m_allowInstantiation:Boolean = false;
      
      private var m_timeZoneOffsetInSeconds:int;
      
      private var m_loginTime:uint;
      
      private var m_localOffsetInSeconds:int;
